...
import DynamicHighlightsPlugin from "../main.ts";
...
export function generateMenu(
	...
	dom?.toggleClass(
		["dynamic-highlights-menu", "dynamic-highlights-search-filter"],
		true
	);
	...
	const generateQueryUI = () => {
		...
		queryMap &&
			queryMap.length &&
			queryMap.forEach((query: SearchColorOption, id: number) => {
...
function createComponent<
	T extends ColorComponent | TextComponent | ExtraButtonComponent
>(
...
function generateColorSelectorSettings({
	...
	const el = dom.createEl("div", {
		cls: "dynamic-highlights-search-filter__query",
	});
...
function generateAddButton({
	...
	const buttonEl = dom.createEl("div", {
		cls: "dynamic-highlights-search-filter__add-query",
	});
